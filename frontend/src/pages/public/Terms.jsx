  ...
  return (
    <div className="max-w-3xl mx-auto px-4 sm:px-6 py-16">
      ...
      <div className="prose prose-slate mt-8 text-slate-700 leading-relaxed space-y-4">
        <p>Bu sənəd BizMarket platformasının istifadə şərtlərini tənzimləyir. Platformadan istifadə etməklə siz bu şərtləri qəbul etmiş sayılırsınız.</p>
        ...
        <p>BizMarket buyer və provider arasında vasitəçi rolundadır. Layihə nəticələrinə görə birbaşa məsuliyyət daşımır.</p>
      </div>
    </div>
  );
}
